...
- [Zerodays Media-player](https://mplayert00l.edgeone.app/) version:1.50.80 (under issue through Google features)/(problem)/(doesn't matched with details old version 
---
...
- **oEmbed Platform Support**: Automatically fetches and embeds players for:
  ...
  - **Apple Music**  (under issues or under process to fix it)
